...
function Home(props) {
  return (
    <div>
      <Carousel>
        <Carousel.Item>
          <img classname="d-block w-100" src="slide-1.jpg" alt="First slide" />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img classname="d-block w-100" src="slide-2.jpg" alt="Second slide" />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img classname="d-block w-100" src="slide-3.jpg" alt="Third slide" />
          <Carousel.Caption>
